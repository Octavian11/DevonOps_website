  ...
  useEffect(() => {
    ...
    const pageSchema = page === "services" ? {
      ...
      mainEntity: [
        ...
        ["Is implementation included?", "It can be. Devonshire leads the scoped operating value-creation workstream and its execution governance, while management owns day-to-day actions and the sponsor retains investment oversight."],
        ["Who performs the work?", "Every engagement is led directly by Hassan Tariq."],
        ["Who owns execution once an engagement begins?", "Devonshire leads the scoped operating value-creation workstream—its evidence, priorities, operating design, governance, cadence, and sponsor visibility. Management owns day-to-day actions; the sponsor retains investment oversight and deal-level decisions."],
